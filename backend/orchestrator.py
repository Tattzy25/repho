...
# Postgres connection for error logging (optional)
db_url = os.getenv("DATABASE_URL")
conn = None
if db_url:
    try:
        # Try psycopg3 first, then fall back to psycopg2 if available
        try:
            ...
            try:
                ...
                raise RuntimeError(
                    "No PostgreSQL driver found. Install 'psycopg[binary]' (recommended) or 'psycopg2-binary'."
                )

        # Ensure autocommit and create table
